...
> 📌 확장 설치 시 "게시자 신뢰 및 설치" 팝업이 표시될 수 있습니다. 이는 확장 프로그램의 게시자를 신뢰할 것인지 확인하는 보안 안내입니다.  
> Spring Boot Extension Pack은 VMware(공식 개발사)에서 제공하는 확장이므로 안전하게 "게시자 신뢰 및 설치" 버튼을 클릭하여 설치를 진행합니다.
