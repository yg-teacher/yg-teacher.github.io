...
|------|------|
| 기본 상태 | 옵션이 비활성화되어 있음 |
| 체크 시 | Hyper-V 위에서 VMware 실행 (WHP 사용) |
| 미체크 시 | Hyper-V 비활성화 필요 |

<img width="497" height="400" alt="image" src="https://github.com/user-attachments/assets/13228f02-0cf1-4b39-9f32-ec56c69f84cb" />
