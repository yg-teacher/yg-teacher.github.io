...
16. Windows 검색창에 "cmd"를 입력한 후 명령 프롬프트를 실행합니다.
<img width="1030" height="1002" alt="image" src="https://github.com/user-attachments/assets/e5495658-96b4-4009-8d1d-4a71a2af0477" />

17. 명령 프롬프트에서 "java -version"과 "javac -version"을 입력하여 Java와 Java 컴파일러가 정상적으로 호출하는지 확인합니다.
<img width="822" height="342" alt="image" src="https://github.com/user-attachments/assets/7531444a-bed8-48f3-8834-2adf2987d1ad" />

## ✅ [결과]
Windows 환경에서 JDK 설치 및 환경 변수 설정을 완료하였으며, Java와 Java 컴파일러가 정상적으로 동작하는 것을 확인했습니다.
